 ...
 */
public class RangeIntegerRegister implements AnnotationRegister<RangeInteger, Integer> {

    @Override
    public void checkAnnotation(RangeInteger annotation, Integer source, ValidationResult validationResult) throws IllegalArgumentException, IllegalAccessException {
